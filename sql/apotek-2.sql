...
INSERT INTO `masuk` (`idmasuk`, `idobat`, `kuantitas`, `supplier`, `tanggal`, `besarharga`) VALUES
(4, 12, 15, '7', '2022-12-29 06:51:01', 20000),
(5, 13, 5, '7', '2022-12-29 07:11:14', 5000);
...
(13, 'Paracetamol', 5000, 'tablet', '2022-12-22', 9, 7),
(14, 'Ibuprofen', 8000, 'tablet', '2031-12-19', 11, 7);
...
INSERT INTO `transaksi` (`id_transaksi`, `tanggal_transaksi`, `jumlah`, `nominal`, `nama_pelanggan`, `nama_dokter`) VALUES
(2, '2022-12-29 09:08:27', 0, 0, 'Ganjoi', 'Lukman'),
(3, '2022-12-29 09:36:55', 0, 0, 'Kagura', 'Hayabusa');
...
--
ALTER TABLE `stock`
  MODIFY `idobat` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
